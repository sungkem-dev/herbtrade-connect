...
const Login = () => {
  ...
  const handleWalletLogin = () => {
    toast.info("Crypto wallet login coming soon!");
  };
        ...
        <CardContent className="p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              >
                <div className="flex items-center space-x-2 border rounded-lg p-3 hover:bg-muted cursor-pointer transition-all">
